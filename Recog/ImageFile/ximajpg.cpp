...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
bool CImageFileJpeg::ReadImageFile(FILE *fp,BYTE* lpExterRawBitsBuff/*=NULL*/,UINT uiBitsBuffSize/*=0*/)
{
	bool is_exif = false;
 ...
 */ //</DP>
	...
	*/
	...
	//if(lpExterRawBitsBuff!=NULL&&uiBitsBuffSize==0)
	//	Create()=NULL;	//此时只读取文件头不解析实质内容
	if(!Create(cinfo.output_width, cinfo.output_height, 8*cinfo.output_components, CXIMAGE_FORMAT_JPG,lpExterRawBitsBuff,uiBitsBuffSize))
		return false;
